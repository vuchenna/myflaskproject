...
class TestRegistration(TestBase):
    def test_registration(self):
        ...
        self.driver.find_element_by_xpath('<xpath for registration first name>').send_keys(test_admin_first_name)
        self.driver.find_element_by_xpath('<xpath for registration last name>').send_keys(test_admin_last_name)
        self.driver.find_element_by_xpath('<xpath for registration password>').send_keys(test_admin_password)
        self.driver.find_element_by_xpath('<xpath for registration check password>').send_keys(test_admin_password)
